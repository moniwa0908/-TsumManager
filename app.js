...
$("#exportButton").onclick=()=>{
  const blob=new Blob([JSON.stringify({app:"TsumManager",version:"7.2.1 Limited",exportedAt:new Date().toISOString(),tsums,history,recent,plans,todayTrainingId,goals,ticketStock,snapshots,dailyTasks,undoHistory},null,2)],{type:"application/json"});
